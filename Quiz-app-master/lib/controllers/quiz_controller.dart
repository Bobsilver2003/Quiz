 ...
 //question variables
  ...
  final List<QuestionModel> _questionsList = [
    QuestionModel(
      ...
      answer: 1,
      options: ['Messi', 'Ronaldo', 'Neymar', 'Zidan '],
    ),
    QuestionModel(
      id: 2,
      question: "Who won the 2022 WC ",
      answer: 0,
      options: ['Argentina', 'France', 'Brazil', 'Portugal'],
    ),
    QuestionModel(
      id: 3,
      question: "How many subs are allowed for a team in a single match",
      answer: 1,
      options: ['2 subs', '5 subs', '3 subs', '1 sub'],
    ),
    QuestionModel(
      id: 4,
      question: "Who won the Ballon d'or 2024",
      answer: 0,
      options: ['Rodri', 'Bellingham', 'Vini', 'Messi'],
    ),
    QuestionModel(
      id: 5,
      question:
          "Who's the top Scorer of Champions League",
      answer: 2,
      options: ['Lewadowski', 'Messi', 'Ronaldo', 'Zlatan'],
    ),
    QuestionModel(
      id: 6,
      question: "How many ballon d'or Messi has ?",
      answer: 1,
      options: ['5', '8', '7', '4'],
    ),
    QuestionModel(
      id: 7,
      question: "The last name of Killian is : ",
      answer: 2,
      options: ['Camavinga', 'Pogba', 'Mbappe', 'Modric'],
    ),
    QuestionModel(
      id: 8,
      question: "Best team OAT :",
      answer: 2,
      options: ['Barcelona', 'Man United', 'Real Madrid', 'Bayern'],
    ),
    QuestionModel(
      id: 9,
      question:
      "The player of Madrid wearing number 10 is : ",
      answer: 1,
      options: ['Mbappe', 'Lucka Modric', 'Arda Guler', 'Ibrahim Diaz'],
    ),
    QuestionModel(
      id: 10,
      question: "Current Real Coach is :",
      answer: 2,
      options: ['Anchelotti', 'Xabi Alonzo', 'Khoder Assad', 'Ibrahim Hussein'],
    ),
  ];
